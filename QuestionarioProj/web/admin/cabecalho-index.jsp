    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class=" mdl-js-ripple-effect mdl-color--primary-dark">
          ...
          <a href="curso/list.jsp" class="mdl-layout__tab">Categoria</a>
          <a href="disciplina/list.jsp" class="mdl-layout__tab">Jogador</a>
          <a href="moniaval/list.jsp" class="mdl-layout__tab">Pergunta</a>
